...
var INTERVENTION = (function (_super) {
    ...
    function INTERVENTION(routerProvider, navParams, loadingCtrl, sanitizer, ref, injector) {
        ...
        _this.form1501596258205 = new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["b" /* FormGroup */]({
            var1501596281670: new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["a" /* FormControl */]('', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].compose([]), __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].composeAsync([])),
            var1501598956173: new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["a" /* FormControl */]('', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].compose([]), __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].composeAsync([])),
            var1501695961656: new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["a" /* FormControl */]('', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].compose([]), __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].composeAsync([])),
            var1501856684540: new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["a" /* FormControl */]('', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].compose([]), __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].composeAsync([])),
        });
        return _this;
        /*Begin_c8o_PageConstructor*/
        /*End_c8o_PageConstructor*/
...
var MyApp = (function () {
    ...
    function MyApp(platform, statusBar, c8o, router, loader, app) {
         ...
         */
        this.pages = [{ title: "Carte des implantations", component: __WEBPACK_IMPORTED_MODULE_5__pages_PLANTS_plants__["a" /* PLANTS */], includedInAutoMenu: true }, { title: "Machines list", component: __WEBPACK_IMPORTED_MODULE_6__pages_MACHINES_machines__["a" /* MACHINES */], includedInAutoMenu: false }, { title: "Machine details", component: __WEBPACK_IMPORTED_MODULE_7__pages_DETAILS_details__["a" /* DETAILS */], includedInAutoMenu: false }, { title: "Intervention form", component: __WEBPACK_IMPORTED_MODULE_8__pages_INTERVENTION_intervention__["a" /* INTERVENTION */], includedInAutoMenu: false }];
